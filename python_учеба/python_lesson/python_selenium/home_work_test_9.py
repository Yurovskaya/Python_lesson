...
card_price_product_2 = driver.find_element(By.XPATH, "(//div[@class='inventory_item_price'])[2]")
card_value_price_product_2 = card_price_product_2.text
print(card_value_price_product_2)
assert value_price_product_2 == card_value_price_product_2
...
#  Удаляю $ у стоимости для первого продукта
number_price_product_1 = finish_value_price_product_1
n = 0
number_price_product_1 = number_price_product_1 [:n] + number_price_product_1 [n+1:]
number_product_1 = float(number_price_product_1)
print(number_price_product_1)

"""Finish cart product # 2"""
...
print("Info finish cart price product # 2 GOOD")

#  Удаляю $ у стоимости для второго продукта
number_price_product_2 = finish_value_price_product_2
n = 0
number_price_product_2 = number_price_product_2 [:n] + number_price_product_2 [n+1:]
number_product_2 = float(number_price_product_2)
print(number_product_2)

summary_price = driver.find_element(By.XPATH, "//div[@class='summary_subtotal_label']")
value_summary_price = summary_price.text
print(value_summary_price)

#  Получаю сумму продуктов
sum_products = number_product_1 + number_product_2
print(sum_products)

item_total = f"Item total: ${sum_products }"
